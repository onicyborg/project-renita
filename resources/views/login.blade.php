...
<body class="light ">
    <div class="wrapper vh-100">
        <div class="row align-items-center h-100">
            <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" action="{{ route('login-post') }}"
                method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="identifier" name="identifier" class="form-control form-control-lg"
                        placeholder="Email or Username" value="{{ old('identifier') }}" required autofocus>
                </div>
                <div class="form-group">
