...
<h3 class="mt-3 text-center">Monitoring &amp; Review ISMS</h3>
...
<div class="table-responsive mt-4">
                ...
                <tr>
                    ...
                    <td>
                        <div style="width: 120px; height: 120px; margin: auto;">
                            <canvas id="section_7_{{ $i + 1 }}"></canvas>
                        </div>
    ...
    <h4 class="mt-4 text-center">Kritik dan Saran Monitoring &amp; Review ISMS</h4>
...
@push('scripts')
    <script>
            ...
            try {
                ...
                if (data) {
                    for (let i = 1; i <= {{ count($questions) }}; i++) {
                        const chart = section_7_charts[i - 1];
                        if (!chart) continue;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Create charts
            for (let i = 1; i <= {{ count($questions) }}; i++) {
                section_7_charts.push(createChart(`section_7_${i}`, {
                    ...dataTemplate2
                }));
            }
