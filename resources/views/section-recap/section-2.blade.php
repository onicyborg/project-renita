...
<div class="table-responsive mt-4">
    ...
    <h4 class="mt-4 text-center">Kritik dan Saran Section 2</h4>
    <div id="kritikSaranCarousel-section-2" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner" id="kritikSaranContent-section-2">
            <div class="carousel-item active">
            </div>
        </div>
        <a class="carousel-control-prev" href="#kritikSaranCarousel-section-2" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>
        <a class="carousel-control-next" href="#kritikSaranCarousel-section-2" role="button" data-slide="next">
...
@push('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                url: `/kritik-saran-section-2/${formId}`,
                method: "GET",
                success: function(data) {
                    let container = $("#kritikSaranContent-section-2");
                    ...
                    $('#kritikSaranCarousel-section-2').carousel();
                },
                error: function() {
