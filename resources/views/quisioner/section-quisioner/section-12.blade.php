        ...
        <div class="card-body">
            ...
            <div class="table-responsive mt-4">
                ...
                <div class="form-group mt-4">
                    ...
                    <textarea class="form-control" id="kritik_saran" name="kritik_saran" rows="4" {{ $status == 'view' ? 'readonly' : '' }}>{{ $auditee->menentukan_portofolio_mitigasi_risiko != null && $auditee->menentukan_portofolio_mitigasi_risiko->kritik_saran != null ? $auditee->menentukan_portofolio_mitigasi_risiko->kritik_saran : '' }}</textarea>
                </div>
            </div>
        </div> <!-- /. card-body -->
