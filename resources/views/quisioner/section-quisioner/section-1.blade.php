        ...
        <div class="card-body">
            ...
            <div class="table-responsive mt-4">
                ...
                <div class="form-group mt-4">
                    ...
                    <textarea class="form-control" id="kritik_saran" name="kritik_saran" rows="4" {{ $status == 'view' ? 'readonly' : '' }}>{{ $auditee->strategi_organisasi != null && $auditee->strategi_organisasi->kritik_saran != null ? $auditee->strategi_organisasi->kritik_saran : '' }}</textarea>
                </div>
            </div>
        </div> <!-- /. card-body -->
