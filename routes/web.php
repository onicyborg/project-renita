...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/kritik-saran-section-1/{id}', [GetDataController::class, 'kritik_saran_section_1'])->name('data.kritik-saran-section-1');
    Route::get('/data-section-2/{id}', [GetDataController::class, 'section_2'])->name('data.section-2');
    Route::get('/kritik-saran-section-2/{id}', [GetDataController::class, 'kritik_saran_section_2'])->name('data.kritik-saran-section-2');
    Route::get('/data-section-3/{id}', [GetDataController::class, 'section_3'])->name('data.section-3');
    Route::get('/kritik-saran-section-3/{id}', [GetDataController::class, 'kritik_saran_section_3'])->name('data.kritik-saran-section-3');
    Route::get('/data-section-4/{id}', [GetDataController::class, 'section_4'])->name('data.section-4');
    Route::get('/kritik-saran-section-4/{id}', [GetDataController::class, 'kritik_saran_section_4'])->name('data.kritik-saran-section-4');
    Route::get('/data-section-5/{id}', [GetDataController::class, 'section_5'])->name('data.section-5');
    Route::get('/kritik-saran-section-5/{id}', [GetDataController::class, 'kritik_saran_section_5'])->name('data.kritik-saran-section-5');
